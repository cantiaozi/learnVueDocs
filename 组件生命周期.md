...
另一种情况，是在createComponent方法中，占位符vnode执行完init钩子后，判断如果vnode.componentInstance存在，那么执行initComponent方法。initComponent方法中，执行invokeCreateHooks方法将vnode push到insertedVnodeQueue中。
